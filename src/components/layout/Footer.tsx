...
const FACEBOOK_URL = "https://www.facebook.com/people/Cliklinkoficialinternet/61561321014210/";
const INSTAGRAM_URL = "https://www.instagram.com/cliklink.oficial/";
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
                className="text-[#555] hover:text-[#F47B20] transition-colors" aria-label="Instagram">
              ...
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer"
                className="text-[#555] hover:text-[#F47B20] transition-colors" aria-label="Facebook">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
